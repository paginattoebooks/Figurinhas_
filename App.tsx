...
const App: React.FC = () => {
  ...
  const mockups = [
    asset("Captura de tela 2026-02-03 154415.png"),
    asset("Captura de tela 2026-02-03 154553.png"),
    asset("Captura de tela 2026-02-03 154608.png"),
    asset("Captura de tela 2026-02-03 154621.png"),
    asset("Captura de tela 2026-02-03 154700.png"),
    asset("Captura de tela 2026-02-03 154707.png"),
    asset("Captura de tela 2026-02-03 154714.png"),
    asset("Captura de tela 2026-02-03 154722.png"),
    asset("Captura de tela 2026-02-03 154733.png"),
    asset("Captura de tela 2026-02-03 154745.png"),
    asset("Captura de tela 2026-02-03 154752.png"),
    asset("Captura de tela 2026-02-03 154800.png"),
    asset("Captura de tela 2026-02-03 154808.png"),
    asset("Captura de tela 2026-02-03 154814.png"),
    asset("Captura de tela 2026-02-03 154825.png"),
];

const premiumMockups = [
  asset("Captura de tela 2026-02-04 141708.png"),
  asset("Captura de tela 2026-02-04 141657.png"),
  asset("Captura de tela 2026-02-04 141651.png"),
  asset("Captura de tela 2026-02-04 141645.png"),
  asset("Captura de tela 2026-02-03 154937.png"),
  asset("Captura de tela 2026-02-03 154608.png"),
];
...
const CHECKOUT_PREMIUM = "https://somasoundsolutions.mycartpanda.com/checkout/206809460:1";
        ...
        <Section>
          ...
          <div className="h-24 w-full flex items-center justify-center">
           <div className="w-64 h-36 md:w-80 md:h-44 rounded-2xl overflow-hidden border-2 border-white/20 mx-auto mb-6 p-2 bg-white/10">
            <img
              src={asset("Captura de tela 2026-02-04 141803.png")}
              alt="Mockup"
              className="w-full h-full object-cover"
              loading="lazy"
            />
          ...
          >
            <div className="w-40 h-72 md:w-48 md:h-80 bg-[#C5A059] rounded-3xl border-2 border-white/20 relative overflow-hidden flex items-center justify-center p-3">
              <img
                src={asset("Captura de tela 2026-02-04 141736.png")}
          ...
          >
            <div className="w-40 h-72 md:w-48 md:h-80 bg-[#C5A059] rounded-3xl border-2 border-white/20 relative overflow-hidden flex items-center justify-center p-3">
              <img
                src={asset("Captura de tela 2026-02-04 141645.png")}
          ...
          >
            <div className="w-40 h-72 md:w-48 md:h-80 bg-[#C5A059] rounded-3xl border-2 border-white/20 relative overflow-hidden flex items-center justify-center p-3">
              <img
                src={asset("Captura de tela 2026-02-04 141651.png")}
          ...
          >
            <div className="w-40 h-72 md:w-48 md:h-80 bg-[#C5A059] rounded-3xl border-2 border-white/20 relative overflow-hidden flex items-center justify-center p-3">
              <img
                src={asset("Captura de tela 2026-02-04 141727.png")}
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    {[
      ...
      <div id="ofertas" className="bg-[#F6F3EB] py-20 border-t-8 border-[#C5A059]">
        <Section>
          {/* Banner Título */}
